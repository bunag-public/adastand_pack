...
@tf_export("train.AdastandOptimizer")
class AdastandOptimizer(optimizer.Optimizer):
  """Optimizer that implements the Adastand algorithm.

  """

  def __init__(self, learning_rate=0.001, beta1=0.7, beta2=0.99, epsilon=1e-8,
               use_locking=False, name="Adastand"):
    """Construct a new Adastand optimizer.
    ...
    Args:
      ...
      name: Optional name for the operations created when applying gradients.
        Defaults to "Adastand".
    """
    super(AdastandOptimizer, self).__init__(use_locking, name)
  ...
  def _apply_dense(self, grad, var):
    ...
    return training_ops.apply_adastand(
        var, m, v,
  ...
  def _resource_apply_dense(self, grad, var):
    m = self.get_slot(var, "m")
    v = self.get_slot(var, "v")
    return training_ops.resource_apply_adastand(
